...
const HealthcareLoginScreen = ({navigation}) => {
  const [data, setData] = React.useState({
    username: 'doctor@guardian.com',
    password: 'doctor123',
  ...
  const handleLogin = async () => {
    ...
    setTimeout(async () => {
      try {
        ...
        if (data.username === 'doctor@guardian.com' && data.password === 'doctor123') {
          ...
          await AsyncStorage.setItem('userType', 'healthcare');
          await AsyncStorage.setItem('providerData', JSON.stringify({
            id: 'prov-123456',
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <View style={styles.logoContainer}>
          ...
          />
          <Text style={styles.headerTitle}>Healthcare Provider Login</Text>
        </View>
      </View>
      ...
      <Animatable.View
        ...
        <View style={styles.formContainer}>
          ...
          >
            <View style={{flexDirection: 'row', alignItems: 'center'}}>
              {loading ? (
                ...
                <MaterialCommunityIcons name="doctor" size={20} color="#FFFFFF" style={{marginRight: 10}} />
              )}
          ...
          <View style={styles.switchProfileContainer}>
            ...
            >
              <MaterialIcons name="switch-account" size={20} color="#2A9D8F" style={{marginRight: 10}} />
...
export default HealthcareLoginScreen;
